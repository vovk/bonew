(function ($) {
    ...
    var defaults = {
        ...
        buttontext: 'e.g. Fitness',
        button: '<button class="btn btn-default dropdown-toggle full-width-select" type="button" data-toggle="dropdown"><span></span> <i class="caret"></i></button>',
        ul: '<ul class="dropdown-menu full-width-menu"></ul>',
